...
function Navbar()  {
  ...
  return (
    <>
     <div className={`max-w-screen-2xl container mx-auto md:px-20 px-4 dark:slate-900 dark:text-white fixed top-0 right-0 z-50 left-0 ${
      sticky
...
<label className="swap swap-rotate p-2">
  ...
  <div >
    <a className="bg-black text-white px-4 py-3 rounded-md hover:bg-slate-800 duration-300 cursor-pointer" onClick={()=> document.getElementById("my_modal_3").showModal()}>Login</a><Login/>
  </div>
</div>
</div>
        </div> 
